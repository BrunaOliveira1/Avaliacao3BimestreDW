                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form role="form" action="${pageContext.request.contextPath}/unidade">
                                            <div class="form-group">
                                                <label>Digite o Id da Unidade de Medida do Produto</label>
                                                <input class="form-control" name="idUnidadeMedida">
                                            </div>
                                            <div class="form-group">
                                                <label>Digite o nome da Unidade de Medida do Produto</label>
                                                <input class="form-control" name="nomeUnidadeMedida" >
                                            </div>
