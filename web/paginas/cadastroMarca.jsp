...
<html lang="en">
    ...
    <body>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cadastro Marca</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" action="${pageContext.request.contextPath}/marca">
                                        <div class="form-group">
                                            <label>Digite o Id da Marca do Produto</label>
                                            <input class="form-control" name="idMarca">
                                        </div>
                                        <div class="form-group">
                                            <label>Digite o nome da Marca do Produto</label>
